...
public class MyTest {
	...
	public static void main(String[] args) throws SQLException {
		...
		// as
		Connection con = DriverManager.getConnection("jdbc:hive2://192.168.189.202:10000/default", "hadoop", "mysql");
		Statement stmt = con.createStatement();
		String tableName = "person100";
...
//		stmt.execute("create table " + tableName + " (key int, value string)");
		...
		String filepath = "/usr/local/hadoop/c.txt";

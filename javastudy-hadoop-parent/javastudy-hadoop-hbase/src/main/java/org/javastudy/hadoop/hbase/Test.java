...
public class Test {
	...
	static {
		...
		conf.set("hbase.zookeeper.quorum", "192.168.189.202");
	...
	public static void main(String[] args) {
		try {
			String tableName = "student99";
			// 第一步：创建数据库表：“student”
			String[] columnFamilys = { "info", "course" };
			Test.createTable(tableName, columnFamilys);
//			// 第二步：向数据表的添加数据
//			// 添加第一行数据
//			if (isExist(tableName)) {
//				Test.addRow(tableName, "zpc", "info", "age", "20");
//				Test.addRow(tableName, "zpc", "info", "sex", "boy");
//				Test.addRow(tableName, "zpc", "course", "china", "97");
//				Test.addRow(tableName, "zpc", "course", "math", "128");
//				Test.addRow(tableName, "zpc", "course", "english", "85");
//				// 添加第二行数据
//				Test.addRow(tableName, "henjun", "info", "age", "19");
//				Test.addRow(tableName, "henjun", "info", "sex", "boy");
//				Test.addRow(tableName, "henjun", "course", "china", "90");
//				Test.addRow(tableName, "henjun", "course", "math", "120");
//				Test.addRow(tableName, "henjun", "course", "english", "90");
//				// 添加第三行数据
//				Test.addRow(tableName, "niaopeng", "info", "age", "18");
//				Test.addRow(tableName, "niaopeng", "info", "sex", "girl");
//				Test.addRow(tableName, "niaopeng", "course", "china", "100");
//				Test.addRow(tableName, "niaopeng", "course", "math", "100");
//				Test.addRow(tableName, "niaopeng", "course", "english", "99");
//				// 第三步：获取一条数据
//				System.out.println("**************获取一条(zpc)数据*************");
//				Test.getRow(tableName, "zpc");
//				// 第四步：获取所有数据
//				System.out.println("**************获取所有数据***************");
//				Test.getAllRows(tableName);
//
//				// 第五步：删除一条数据
//				System.out.println("************删除一条(zpc)数据************");
//				Test.delRow(tableName, "zpc");
//				Test.getAllRows(tableName);
//				// 第六步：删除多条数据
//				System.out.println("**************删除多条数据***************");
//				String rows[] = new String[] { "qingqing", "xiaoxue" };
//				Test.delMultiRows(tableName, rows);
//				Test.getAllRows(tableName);
//				// 第七步：删除数据库

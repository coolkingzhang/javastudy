package org.javastudy.cache.redis;
...
public class JedisUtilTest {
	...
	@Before
	public void setUp() {
		pool = new JedisPool(new JedisPoolConfig(), "10.73.128.87", 6379);
	...
	public void testGet() {
		...
		jedis.hset("hkey", "username", "henry zhang");
		System.out.println(jedis.get("key"));
		System.out.println(jedis.hget("hkey", "username"));
		// }
	}
